...
export default function SolutionsPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-foreground/70">
                Het probleem dat Marcel oplost
              </p>
            </div>
            
            <div className="space-y-6 text-xl text-foreground/80 leading-relaxed">
              <p>
                In 2024 en 2025 zijn er honderden AI-pilots gestart. Prototypes werden gebouwd, budgetten werden vrijgemaakt, en de verwachtingen waren torenhoog.
              </p>
              <p>
                Nu, in 2026, begint de realiteit in te dalen: veel van die pilots zijn vastgelopen. Technical debt stapelt zich op, de codebase is een lappendeken, en het engineering team kan de groei niet bijhouden. <strong className="text-foreground">De 'AI Hangover' is een feit.</strong>
              </p>
              <p className="text-accent-orange font-semibold text-2xl">
                De oplossing? Een Turnaround CTO die het fundament herstelt en je organisatie AI Act compliant maakt.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Expertise & Ervaring */}
      <section id="expertise" className="py-20 lg:py-32 bg-surface-dark">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center mb-16">
            ...
            <div className="flex flex-col lg:flex-row items-start gap-6 mb-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-xl text-foreground/80 mb-6 leading-relaxed">
                  Weet je niet waar je moet beginnen? Start met een diepgaande 3-daagse audit van je technische architectuur, codebase en team-processen. Ontvang een concreet actieplan om de AI Hangover te overwinnen.
                </p>
      ...
      <section className="py-20 lg:py-32 bg-gradient-to-br from-accent-blue/10 via-background to-background border-y border-accent-blue/20">
        <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="bg-surface-dark border-2 border-accent-blue/40 rounded-3xl p-8 lg:p-12 shadow-[0_0_40px_rgba(0,102,255,0.2)]">
            <div className="text-center mb-8">
              <div className="inline-block px-4 py-2 bg-accent-blue/20 rounded-full mb-4">
                <span className="text-accent-blue font-semibold">Nog geen prototype?</span>
              </div>
              <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-4">
                Start with the Vibe
              </h2>
              <p className="text-xl text-foreground/80 leading-relaxed max-w-3xl mx-auto">
                Voordat Marcel een fortress bouwt, heb je een gevalideerd prototype nodig. In Michel's Academy leer je vibecoding en bouw je binnen dagen je eerste werkende AI-applicatie.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="text-center">
                ...
                <h3 className="text-lg font-bold text-foreground mb-2">Rapid Validation</h3>
                <p className="text-foreground/70 text-sm">Van idee naar werkend prototype in uren</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-bold text-foreground mb-2">Certificering</h3>
                <p className="text-foreground/70 text-sm">Word gecertificeerd AI-architect</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-bold text-foreground mb-2">Team Transformatie</h3>
                <p className="text-foreground/70 text-sm">Van denkers naar makers</p>
              </div>
            </div>
