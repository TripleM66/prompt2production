              ...
              <div className="mt-8">
                ...
                <div className="flex flex-wrap gap-3">
                  {[
                    ...
                    <span
                      key={index}
                      className="px-4 py-2 bg-accent-blue/30 text-accent-blue rounded-full text-base font-semibold border border-accent-blue/40"
                    >
                      {skill}
                    </span>
                  ))}
              ...
              <div className="mt-8">
                ...
                <div className="flex flex-wrap gap-3">
                  {[
                    ...
                    <span
                      key={index}
                      className="px-4 py-2 bg-accent-orange/30 text-accent-orange rounded-full text-base font-semibold border border-accent-orange/40"
                    >
                      {skill}
                    </span>
                  ))}
